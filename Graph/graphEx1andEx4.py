...
def test():
    ...
    print("\nShortest Path from 7 to 6 is {}".format(myGraph.minNumberOfEdges(7, 6)))

    nodeForShortestPath = [0,1,2,3,4,5,6]
    myGraphForShortestPath = GraphWithAdjacencyList()
    for i in nodeForShortestPath:
        myGraphForShortestPath.addNode(i)
    myGraphForShortestPath.addEdge(3, 4)
    myGraphForShortestPath.addEdge(4, 5)
    myGraphForShortestPath.addEdge(4, 0)
    myGraphForShortestPath.addEdge(4, 6)
    myGraphForShortestPath.addEdge(5, 2)
    myGraphForShortestPath.addEdge(2, 1)
    myGraphForShortestPath.addEdge(2, 0)
    myGraphForShortestPath.addEdge(1, 0)

    print("\nShortest Path from 3 to 1 is {}".format(myGraphForShortestPath.minNumberOfEdges(3, 1)))
    print("\nShortest Path from 6 to 5 is {}".format(myGraphForShortestPath.minNumberOfEdges(6, 5)))
    print("\nShortest Path from 2 to 3 is {}".format(myGraphForShortestPath.minNumberOfEdges(2, 3)))
